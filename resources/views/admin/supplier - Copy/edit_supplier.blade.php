<form method="POST" action="{{url('update-supplier')}}" enctype="multipart/form-data">
		...
		<input type="hidden" class="form-control" name="ed_supplier_id" value="{{$sp->id}}">
		...
		<div class="form-group">
			<div class="row">
			  ...
			  <div class="col-lg-9 col-xl-9 col-xxl-9">
				 <input type="text" class="form-control input-default "  name="ed_supplier_name"  value="{{$sp->supplier_name}}" required>
			  </div>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			  ...
			  <div class="col-lg-9 col-xl-9 col-xxl-9">
				 <input type="text" class="form-control input-default "  name="ed_gst_no" value="{{$sp->gst_no}}" required>
			  </div>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			  ...
			  <div class="col-lg-9 col-xl-9 col-xxl-9">
				 <input type="text" class="form-control input-default "  name="ed_pan_no" value="{{$sp->pan_no}}" required>
			  </div>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			  ...
			  <div class="col-lg-9 col-xl-9 col-xxl-9">
				 <input type="text" class="form-control input-default "  name="ed_tin_no" value="{{$sp->tin_no}}" required>
			  </div>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			  ...
			  <div class="col-lg-9 col-xl-9 col-xxl-9">
				 <input type="text" class="form-control input-default "  name="ed_contact_person" value="{{$sp->contact_person}}" required>
			  </div>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			  ...
			  <div class="col-lg-9 col-xl-9 col-xxl-9">
				 <input type="number" class="form-control input-default "  name="ed_mobile" value="{{$sp->mobile}}" required>
			  </div>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			  ...
			  <div class="col-lg-9 col-xl-9 col-xxl-9">
				 <textarea class="form-control" name="ed_address"  required>{{$sp->address}}</textarea>
			  </div>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			  ...
			  <div class="col-lg-9 col-xl-9 col-xxl-9">
				  <input type="text" class="form-control input-default "  name="ed_bank_name" value="{{$sp->bank_name}}" required>
			  </div>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			  ...
			  <div class="col-lg-6 col-xl-6 col-xxl-6">
				  <input type="text" class="form-control input-default "  name="ed_bank_ifsc" value="{{$sp->bank_ifsc}}" required>
			  </div>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			  ...
			  <div class="col-lg-9 col-xl-9 col-xxl-9">
				  <input type="text" class="form-control input-default "  name="ed_bank_account_no" value="{{$sp->bank_account_no}}" required>
			  </div>
			</div>
		</div>
