...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Main Items For Cost Center</h4>
					</div>
					</div>
				</div>
			...
			<div class="mt-3">
			<label class="mb-3" style="font-size:11px;"><b><u>Add Staff Role</u></b> </label>
				<form method="POST" action="{{url('save-cost-item')}}" enctype="multipart/form-data">
				@csrf
		
					<div class="form-group">
					<label>Main Item Name</label>
					   <input type="text" class="form-control input-default" name="main_item" required>
					   @if($errors->has('main_item'))
						 <label class="lbl-error">{{$errors->first('main_item')}}</label>
					   @endif
					</div>
	...
	<div class="modal fade" id="basicModal-1" style="display: none;" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form method="POST" action="{{url('update-cost-item')}}" enctype="multipart/form-data">
				@csrf
				
				<input type="hidden" id="ed_cost_item_id" name="ed_cost_item_id">
				
				<div class="modal-body" style="padding-bottom:.5rem;">
					<div class="form-group">
					<label>Main Coat Item </label>
					   <input type="text" class="form-control input-default"  id="ed_main_item" name="ed_main_item" required>
					</div>
 ...
 $('#datatable tbody').on( 'click', '.edit', function ()
  {
	...
	$("#ed_cost_item_id").val(id);
	$("#ed_main_item").val(item);
		...
		if(confirm("Are you sure, delete this?"))
		{
			var id=$(this).attr('id');
				...
				success: function(res)
				{
				   ...
				   {
					  table.draw();
					  alert("Cost item successfully removed.");
				   }
				}
			});
		}
