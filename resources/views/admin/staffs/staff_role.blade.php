...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Admin/Staff Roles</h4>
					</div>
					</div>
				</div>
			...
			<div class="mt-3">
			<label class="mb-3" style="font-size:11px;"><b><u>Add Admin/Staff Role</u></b> </label>
				<form method="POST" action="{{url('save-staff-role')}}" enctype="multipart/form-data">
				@csrf

					<div class="form-group">
					<label>Staff Role Name</label>
					   <input type="text" class="form-control input-default"  name="role_name" required>
					  @if($errors->has('role_name'))
						 <label class="lbl-error">{{$errors->first('role_name')}}</label>
					   @endif
					</div>
		...
		if(confirm("Are you sure, delete this?"))
		{
			var id=$(this).attr('id');
				...
				success: function(res)
				{
				   ...
				   {
					  table.draw();
					  alert("Staff role successfully removed.");
				   }
				}
			});
		}
