		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Edit Staff Details</h4>
					</div>
					</div>
				</div>
			...
			<div class="card-body pb-4 pt-0" id="RecentActivitiesContent">
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-3 col-xl-3 col-xxl-3">
					     <input type="date" class="form-control input-default "  name="join_date"  value="{{ $st->join_date}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					     <input type="text" class="form-control input-default "  name="name"  value="{{$st->name}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					     <textarea class="form-control"  name="address" required>{{$st->address}}</textarea>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6" style="display:flex;">
					     <input type="radio" class="ml-3"  name="gender" value="MALE" style="width:25px;height:25px;align-items:center;" @if($st->gender=="MALE"){{__('checked')}}@endif required>&nbsp;&nbsp;Male 
						 <input type="radio"  class="ml-3"  name="gender" value="FEMALE" style="width:25px;height:25px;align-items:center;" @if($st->gender=="FEMALE"){{__('checked')}}@endif required>&nbsp;&nbsp;Female
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					     <input type="number" class="form-control input-default "  name="mobile" value="{{$st->mobile}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					     <input type="email" class="form-control input-default "  name="email" value="{{$st->email}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					     <input type="text" class="form-control input-default "  name="qualification" value="{{$st->qualification}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					     <input type="text" class="form-control input-default "  name="aadhar_no" value="{{$st->aadhar_no}}"required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-4 col-xl-4 col-xxl-4">
					     <input type="text" class="form-control input-default "  name="pan_no" value="{{$st->pan_no}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-4 col-xl-4 col-xxl-4">
						 ...
						 @foreach($roles as $r)
						    <option value="{{$r->id}}" @if($r->id==$st->staff_role_id){{__('selected')}}@endif >{{$r->role}}</option>
						 @endforeach
						 </select>
					  </div>
					</div>
				...
				<!--<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-4 col-xl-4 col-xxl-4">
					     <input type="number" class="form-control input-default "  name="salary" value="{{$st->salary}}" required>
					  </div>
					</div>
				</div>--->
				...
				<div class="form-group">
					<div class="row">
						<label class="col-lg-2 col-xl-2 col-xxl-2 col-form-label" >ESIC</label>
					  <div class="col-lg-3 col-xl-3 col-xxl-3">
					     <input type="text" class="form-control input-default "  name="esic" value="{{$st->esic}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  <label class="col-lg-2 col-xl-2 col-xxl-2 col-form-label" >PF</label>
					  <div class="col-lg-3 col-xl-3 col-xxl-3">
					     <input type="text" class="form-control input-default "  name="pf" value="{{$st->pf}}"required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					      <input type="text" class="form-control input-default "  name="bank_name" value="{{$st->bank_name}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-4 col-xl-4 col-xxl-4">
					      <input type="text" class="form-control input-default "  name="bank_ifsc" value="{{$st->bank_ifsc}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					      <input type="text" class="form-control input-default "  name="bank_account_no" value="{{$st->bank_account_no}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					     <input type="text" class="form-control input-default "  name="state" value="{{$st->state}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					     <input type="text" class="form-control input-default "  name="district" value="{{$st->district}}" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					      <input type="text" class="form-control input-default "  name="nationality" value="{{$st->nationality}}" required>
					  </div>
					</div>
				</div>
