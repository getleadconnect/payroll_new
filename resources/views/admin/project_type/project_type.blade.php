...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Project Types</h4>
					</div>
					</div>
				</div>
			...
			<div class="mt-3">
			<label class="mb-3" style="font-size:11px;"><b><u>Add Project Type</u></b> </label>
				<form method="POST" action="{{url('save-project-type')}}" enctype="multipart/form-data">
				@csrf

					<div class="form-group">
					<label>Project Type</label>
					   <input type="text" class="form-control input-default"  name="project_type" required>
					   @if($errors->has('project_type'))
						 <label class="lbl-error">{{$errors->first('project_type')}}</label>
					   @endif
					</div>
	...
	<div class="modal fade" id="basicModal-1" style="display: none;" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form method="POST" action="{{url('update-project-type')}}" enctype="multipart/form-data">
				@csrf
				
				<input type="hidden" id="ed_project_type_id" name="ed_project_type_id">
				
				<div class="modal-body" style="padding-bottom:.5rem;">
					<div class="form-group">
					<label>Project Type</label>
					   <input type="text" class="form-control input-default"  id="ed_project_type" name="ed_project_type" required>
					</div>
 ...
 $('#datatable tbody').on( 'click', '.edit', function ()
  {
	...
	$("#ed_project_type_id").val(id);
	$("#ed_project_type").val(ptype);
		...
		if(confirm("Are you sure, delete this?"))
		{
			var cid=$(this).attr('id');
				...
				success: function(res)
				{
				   ...
				   {
					  table.draw();
					  alert("Project type successfully removed.");
				   }
				}
			});
		}
