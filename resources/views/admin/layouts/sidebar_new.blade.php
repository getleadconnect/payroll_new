 <!--**********************************
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				...
				@if($role==1)
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="fas fa-dollar" style="font-size:16px;"></i>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{{url('all-labour-wages')}}"><i class="fas fa-caret-right"></i>View All Labour Wages</a></li>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        	...
                        	<li><a href="{{url('view-summation-report')}}"><i class="fas fa-caret-right"></i>View Project Summation</a></li>
							<li><a href="{{url('material-supplier-analysis')}}"><i class="fas fa-caret-right"></i>Material Supplier Analysis</a></li>
							<li><a href="{{url('project-supplier-analysis')}}"><i class="fas fa-caret-right"></i>Project Supplier Materials</a></li>
							<li><a href="{{url('vendor-project-analysis')}}"><i class="fas fa-caret-right"></i>Vendor Project Analysis</a></li>
							<li><a href="{{url('project-vendor-analysis')}}"><i class="fas fa-caret-right"></i>Project Vendor Analysis</a></li>
							<li><a href="{{url('project-misc-analysis')}}"><i class="fas fa-caret-right"></i>Project Misc-Analysis</a></li>
							<li><a href="{{url('category-misc-analysis')}}"><i class="fas fa-caret-right"></i>Category Misc-Analysis</a></li>
							<li><a href="{{url('project-labours-details')}}"><i class="fas fa-caret-right"></i>Project Labours Details</a></li>
			...
			@elseif($role==5)   <!---- OFFICE INCHARGER ---------------->
