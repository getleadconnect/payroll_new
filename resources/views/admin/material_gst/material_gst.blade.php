...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Material GST</h4>
					</div>
					</div>
				</div>
			...
			<div class="mt-3">
			<label class="mb-3" style="font-size:11px;"><b><u>Add Material GST</u></b> </label>
			
				<form method="POST" action="{{url('save-material-gst')}}" enctype="multipart/form-data">
				@csrf
					...
					<div class="form-group">
					<label>Material GST(%)</label>
					   <input type="number" class="form-control input-default" step="any" style="width:175px;" name="gst" required>
					</div>
					
					<div class="form-group">
					<label>GST Date</label>
					   <input type="date" class="form-control input-default" style="width:175px;" name="gst_date" required>
					</div>
		...
		if(confirm("Are you sure, delete this?"))
		{
			var cid=$(this).attr('id');
				...
				success: function(res)
				{
				   ...
				   {
					  table.draw();
					  alert("Material gst successfully removed.");
				   }
				}
			});
		}
