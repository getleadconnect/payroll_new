...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Skill Types</h4>
					</div>
					</div>
				</div>
			...
			<div class="mt-3">
			<label class="mb-3" style="font-size:11px;"><b><u>Add Skill Type</u></b> </label>
				<form method="POST" action="{{url('save-skill-type')}}" enctype="multipart/form-data">
				@csrf

					<div class="form-group">
					<label>Skill Type</label>
					   <input type="text" class="form-control input-default"  name="skill_type" required>
					   @if($errors->has('skill_type'))
						 <label class="lbl-error">{{$errors->first('skill_type')}}</label>
					   @endif
					</div>
	...
	<div class="modal fade" id="basicModal-1" style="display: none;" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form method="POST" action="{{url('update-skill-type')}}" enctype="multipart/form-data">
				@csrf
				
				<input type="hidden" id="ed_skill_type_id" name="ed_skill_type_id">
				
				<div class="modal-body" style="padding-bottom:.5rem;">
					<div class="form-group">
					<label>Skill Type</label>
					   <input type="text" class="form-control input-default"  id="ed_skill_type" name="ed_skill_type" required>
					</div>
...
var table = $('#datatable').DataTable({
 ...
 $('#datatable tbody').on( 'click', '.edit', function ()
  {
	var id=$(this).attr('id');
	var stype=$(this).attr('data-val');
	
	$("#ed_skill_type_id").val(id);
	$("#ed_skill_type").val(stype);
		...
		if(confirm("Are you sure, delete this?"))
		{
			var id=$(this).attr('id');
				...
				success: function(res)
				{
				   ...
				   {
					  table.draw();
					  alert("Skill type successfully removed.");
				   }
				}
			});
		}
