...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Asset Category</h4>
					</div>
					</div>
				</div>
			...
			<div class="mt-3">
			<label class="mb-3" style="font-size:11px;"><b><u>Add Asset Category</u></b> </label>
				<form method="POST" action="{{url('save-asset-category')}}" enctype="multipart/form-data">
				@csrf
	...
	<div class="modal fade" id="basicModal-1" style="display: none;" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form method="POST" action="{{url('update-asset-category')}}" enctype="multipart/form-data">
				@csrf
 ...
 $('#datatable tbody').on( 'click', '.edit', function ()
  {
	...
	$("#ed_category_id").val(id);
	$("#ed_category_name").val(ptype);
