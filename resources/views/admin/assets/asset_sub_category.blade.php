	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Asset Sub-Category</h4>
					</div>
					</div>
				</div>
			...
			<label class="mb-3" style="font-size:11px;"><b><u>Add Sub Category</u></b> </label>
				<form method="POST" action="{{url('save-asset-sub-category')}}" enctype="multipart/form-data">
				@csrf

					<div class="form-group">
					<label>Category</label>
					   <select class="form-control input-default"  name="category_id" required>
	...
	var cid=$(this).attr('id');
		...
		var Result=$("#basicModal-1 .modal-body");
			...
			$(this).attr('data-target','#basicModal-1');
				...
				jQuery.ajax({
				type: "GET",
				url: "edit-asset-sub-category"+"/"+cid,
				dataType: 'html',
				//data: {vid: vid},
...
$('#datatable tbody').on( 'click', '.btndel', function ()
  {
		if(confirm("Are you sure, delete this?"))
		{
			var cid=$(this).attr('id');
				jQuery.ajax({
				type: "GET",
				url: "delete-asset-sub-category"+"/"+cid,
				dataType: 'html',
				//data: {vid: vid},
				success: function(res)
				{
