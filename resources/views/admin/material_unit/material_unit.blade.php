...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Material Units</h4>
					</div>
					</div>
				</div>
			...
			<div class="mt-3">
			<label class="mb-3" style="font-size:11px;"><b><u>Add Material Unit</u></b> </label>
				<form method="POST" action="{{url('save-material-unit')}}" enctype="multipart/form-data">
				@csrf

					<div class="form-group">
					<label>Material Unit Name</label>
					   <input type="text" class="form-control input-default"  name="unit_name" required>
					   @if($errors->has('unit_name'))
						 <label class="lbl-error">{{$errors->first('unit_name')}}</label>
					   @endif
					</div>
	...
	<div class="modal fade" id="basicModal-1" style="display: none;" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form method="POST" action="{{url('update-material-unit')}}" enctype="multipart/form-data">
				@csrf
				
				<input type="hidden" id="ed_mat_unit_id" name="ed_mat_unit_id">
				
				<div class="modal-body" style="padding-bottom:.5rem;">
					<div class="form-group">
					<label>	Material Unit Name</label>
					   <input type="text" class="form-control input-default"  id="ed_unit_name" name="ed_unit_name" required>
					</div>
 ...
 $('#datatable tbody').on( 'click', '.edit', function ()
  {
	...
	$("#ed_mat_unit_id").val(id);
	$("#ed_unit_name").val(uname);
		...
		if(confirm("Are you sure, delete this?"))
		{
			var cid=$(this).attr('id');
				...
				success: function(res)
				{
				   ...
				   {
					  table.draw();
					  alert("Material unit successfully removed.");
				   }
				}
			});
		}
