	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
			...
			<div class="card-body pb-4 pt-0" id="RecentActivitiesContent">
				...
				<div class="col-lg-7 col-xl-7 col-xxl-7 text-right">
				  <label class="col-form-label" style="font-size:16px;" >Total Amount:&nbsp;&nbsp;<b><span id="tot_Amount"></span></b></label>
				</div>
