...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Project Vendor Analysis</h4>
					</div>
					</div>
				</div>
			...
			<form method="post" action="{{ url('project-vendor-analysis')}}">
			@csrf
							...
							@if(!empty($mdata))
							   @foreach($mdata as $key=>$r)
								...
								<tr style="height:25px;">
									...
									<td class="st-td">{{$r->vendor_name}}</td>
