...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Category Misc-Expense Analysis</h4>
					</div>
					</div>
				</div>
			...
			<form method="post" action="{{ url('category-misc-analysis')}}">
			@csrf
							  ...
							  <tr>
								@if(!empty($mdata))
									<td class="st-td" colspan=7 align="left" style="font-size:14px;">
										<label style="padding-top:10px;">Misc-Category:&nbsp;&nbsp;&nbsp;<b>{{$mdata[0]->category_name??""}}</b></label>
										@if($sdate!="" and $edate!="")
								...
								@else
									<td class="st-td" colspan=10 align="left">
										<p class="mb-0 pt-2" >Misc-Category: ...</p>
