...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Vendor Project Analysis</h4>
					</div>
					</div>
				</div>
			...
			<form method="post" action="{{ url('vendor-project-analysis')}}">
			@csrf
			<div class="row mt-1 pt-2 pb-2 filter-box">
				<label class="col-lg-2 col-xl-2 col-xxl-2 col-form-label text-right">Select Vendor</label>
				<div class="col-lg-3 col-xl-3 col-xxl-3">
				<select type="text" class="form-control" id="vendor_id" name="vendor_id" required>
							  ...
							  <tr>
								@if(!empty($mdata))
									<td class="st-td" colspan=7 align="left" style="font-size:14px;">
										<label style="padding-top:10px;">Vendor:&nbsp;&nbsp;&nbsp;<b>{{$mdata[0]->vendor_name??""}}</b></label>
										@if($sdate!="" and $edate!="")
								...
								<tr style="line-height:30px;">
									...
									<th class="st-td" style="text-align:right">GST_AMOUNT</th>
							...
							@if(!empty($mdata))
							   @foreach($mdata as $key=>$r)
								...
								<tr style="height:25px;">
									...
									<td class="st-td">{{$r->description}}</td>
									<td class="st-td" align="right">{{number_format($r->gst_amount,2,'.','')}}</td>
									<td class="st-td" align="right">{{number_format($r->total_amount,2,'.','')}}</td>
								</tr>
