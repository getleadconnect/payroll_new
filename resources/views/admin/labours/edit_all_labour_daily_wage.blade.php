<form  method="POST" action="{{ url('update-all-daily-wage')}}" enctype="multipart/form-data">
  @csrf
	...
	<div class="form-group">
	  ...
	  <div class="col-lg-6 col-xl-6 col-xxl-6">
	     ...
	     <input type="date" class="form-control " style="width:150px;" id="ed_entry_date"  name="ed_entry_date" value="{{$ldw->entry_date}}" required>
	  </div>
		...
		<div class="col-lg-6 col-xl-6 col-xxl-6 mt-2">
		...
		<div class="col-lg-6 col-xl-6 col-xxl-6 mt-2">
			 ...
			 <input type="number" class="form-control over_time text-right"  style="width:100px;" min="0" max="8"id="ed_over_time"  name="ed_over_time" value="{{$ot}}" required>
		</div>
	  </div>
	</div>
