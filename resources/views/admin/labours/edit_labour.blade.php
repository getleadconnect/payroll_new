	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-2">
						<h4 class="text-black fs-20">Edit</h4>
					</div>
					</div>
				</div>
			...
			<div class="card-body pl-5 pb-4 pt-0" >
				...
				<form method="POST" action="{{url('update-labour')}}" enctype="multipart/form-data">
				@csrf

				<label style="font-size:11px;color:red;" class="mt-3 mb-2">(All fields are mandatory)</label>
				
				<input type="hidden" name="labour_id" value="{{$lbr->id}}">
								
			    <div class="form-group">
					<div class="row">
					
					<label class="col-lg-2 col-xl-2 col-xxl-2 col-form-label">Code</label>
					<div class="col-lg-4 col-xl-4 col-xxl-4">
					   <label style="font-size:11px;color:blue;">3 Character & 4 digits (Eg: ABC1234) </label>
					   <input type="text" class="form-control input-default" pattern="[A-Za-z]{3}\d{4}" maxlength="7" id="code" name="code" value="{{$lbr->code}}" readonly>
					    @if($errors->has('code'))
				...
				<div class="form-group">
					...
					<div class="col-lg-7 col-xl-7 col-xxl-7">
					   <input type="text" class="form-control input-default" id="name" name="name" value="{{$lbr->name}}" required>
					</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-4 col-xl-4 col-xxl-4">
					  ...
					  @foreach($skill as $r)
					   <option value="{{$r->id}}" @if($r->id==$lbr->skill_type_id){{__('selected')}}@endif>{{$r->skill_type}}</option>
					  @endforeach
				     </select>
					</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-3 col-xl-3 col-xxl-3">
					   <input type="date" class="form-control input-default" id="birth_date" name="birth_date" value="{{$lbr->birth_date}}">
					</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-7 col-xl-7 col-xxl-7" style="display:flex;">
					     <input type="radio" class="ml-3"  name="gender" value="MALE" style="width:25px;height:25px;align-items:center;" @if($lbr->gender=="MALE"){{__('checked')}}@endif required><span class="mt-1 pl-2">Male</span>
						 <input type="radio"  class="ml-3"  name="gender" value="FEMALE" style="width:25px;height:25px;align-items:center;" @if($lbr->gender=="FEMALE"){{__('checked')}}@endif required><span class="mt-1 pl-2">Female</span>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-7 col-xl-7 col-xxl-7">
					   <input type="number" class="form-control input-default " id="mobile" name="mobile" value="{{$lbr->mobile}}" required>
					</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-7 col-xl-7 col-xxl-7">
					     <textarea class="form-control input-default" id="address" name="address" style="height:80px;" required>{{$lbr->address}}</textarea>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-5 col-xl-5 col-xxl-5">
					     <input type="text" class="form-control input-default " id="state" name="state" value="{{$lbr->state}}"required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-5 col-xl-5 col-xxl-5">
					   <input type="text" class="form-control input-default" id="district" name="district" value="{{$lbr->district}}" required>
					</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-5 col-xl-5 col-xxl-5">
						<input type="text" class="form-control input-default" name="nationality" id="nationality" value="{{$lbr->nationality}}">
					</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-5 col-xl-5 col-xxl-5">
					     <input type="text" class="form-control input-default" id="aadhar_no" name="aadhar_no" value="{{$lbr->aadhar_no}}" required>
