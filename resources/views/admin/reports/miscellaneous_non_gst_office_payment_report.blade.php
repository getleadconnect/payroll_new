		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Miscellaneous (NON-GST) Office Payment Report</h4>
					</div>
					</div>
				</div>
		  ...
		  <div class="row mt-3">
			<div class="col-xl-12 col-xxl-12 col-lg-12">
				...
				@if(!empty($data))
					...
					<tr><th class="text-center fs-14 mb-2">MISCELLANEOUS (NON-GST) OFFICE PAYMENT </th></tr>
					...
					@php $tot=0; $gtot=0;  @endphp
					  ...
					  @foreach($data as $key=>$r)
						...
						<tr>
							...
							<td style="border-bottom:1px solid #e4e4e4;" align="right">{{number_format($r['amt'],2,'.',',')??''}}</td>
						</tr>
					@endforeach

					</tbody>
					</table>
					<table id="tb-list" border=0 style="width:100%;font-weight:500;">
					<tr>
						<th style="text-align:right;border-top:1px solid #727272;border-bottom:1px solid #727272;">
						<span style="margin-right:20px;font-size:15px;">Total&nbsp;:&nbsp;</span>
						<span style="width:200px;font-size:15px;text-align:right;margin-right:5px;">{{$data[0]['total']}}</span></th>
					</tr>
					</table>
