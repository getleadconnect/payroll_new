	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
			...
			<div class="card-body pb-4 pt-0" id="RecentActivitiesContent">
			  ...
			  <form method="POST" action="{{url('summation-report')}}" enctype="multipart/form-data">
				@csrf
				...
				<label class="col-lg-1 col-xl-1 col-xxl-1 col-form-label text-right">Project</label>
				   ...
				   <label class="col-lg-1 col-xl-1 col-xxl-1 col-form-label text-right">Date:</label>
					...
					<div class="col-lg-2 col-xl-2 col-xxl-2">
						<input type="date" class="form-control" type="text" id="flt_start_date" name="flt_start_date" value="{{$start_date}}" required>
					</div>
					@endif
					<div class="col-lg-2 col-xl-2 col-xxl-2">
						<input type="date" class="form-control" type="text" id="flt_end_date" name="flt_end_date" value="{{$thu_date}}" required>
					</div>
...
<!--- staff salry list --------------------------------------------->
			...
			<div id="printArea">
					...
					$dt="";
						...
						{
						   $dt=$data['start_date']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; To &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ".$data['end_date'];
						}
					@endphp
					
					<tr><td class="text-center" align="center" style="font-size:14px;">{!! $dt !!}</td></tr>
...
$("#flt_end_date").change(function()
{
	let dtString = moment($(this).val().toString()).subtract(6, 'days').format("YYYY-MM-DD");
	$("#flt_start_date").val(dtString);
});
