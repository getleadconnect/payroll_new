...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Miscellaneous (GST) Site Report</h4>
					</div>
					</div>
				</div>
			...
			<form method="POST" action="miscellaneous-gst-report">
			  @csrf
		  ...
		  <div class="row mt-3">
			<div class="col-xl-12 col-xxl-12 col-lg-12">
				...
				@if(!empty($data))
					...
					<tr><th class="text-center fs-14 mb-2">MISCELLANEOUS-GST SITE</th></tr>
					...
					<tr >
						<th colspan=5 style="text-align:right;border-top:1px solid #727272;border-bottom:1px solid #727272;">
						Total : &nbsp;
						</th>
