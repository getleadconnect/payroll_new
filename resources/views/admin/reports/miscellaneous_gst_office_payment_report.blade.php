...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Miscellaneous (GST) Office Payment Report</h4>
					</div>
					</div>
				</div>
			...
			<form method="POST" action="misc-gst-office-payment">
			  @csrf
		  ...
		  <div class="row mt-3">
			<div class="col-xl-12 col-xxl-12 col-lg-12">
				...
				@if(!empty($data))
					...
					<tr><th class="text-center fs-14 mb-2">MISCELLANEOUS-GST OFFICE PAYMENT</th></tr>
					...
					<tr >
						...
						<th style="border-top:1px solid #727272;border-bottom:1px solid #727272; text-align:right;" >GST_Amount&nbsp;&nbsp;</th>
					...
					@if(!empty($data))
						...
						<tr>
							...
							<td style="border-bottom:1px solid #e4e4e4;">{{$r['vname']??''}}</td>
							<td style="border-bottom:1px solid #e4e4e4;">{{$r['desc']??''}}</td>
							<td style="border-bottom:1px solid #e4e4e4;">{{$r['ptype']??''}}</td>
							<td style="border-bottom:1px solid #e4e4e4;width:120px;" align="right">{{$r['gst_amt']??''}}</td>
							<td style="border-bottom:1px solid #e4e4e4;width:120px;" align="right">{{$r['amt']??''}}</td>
						</tr>
						@endforeach
					@endif
					</tbody>
					...
					<tr >
						<th colspan=6 style="text-align:right;border-top:1px solid #727272;border-bottom:1px solid #727272;">
						Total : &nbsp;
						</th>
						<th  style="width:120px;text-align:right;border-top:1px solid #727272;border-bottom:1px solid #727272;">
						<span style="width:200px;font-size:14px;text-align:right;">{{$data[0]['total_gst']??0}}</span>
						</th>
						<th  style="width:120px;text-align:right;border-top:1px solid #727272;border-bottom:1px solid #727272;">
						<span style="width:200px;font-size:14px;text-align:right;">{{$data[0]['total_amount']??0}}</span>
						</th>
					</tr>
					</tfoot>
					</table>
