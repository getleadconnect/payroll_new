...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Material (GST) Office Payment Report</h4>
					</div>
					</div>
				</div>
			...
			<form method="POST" action="material-gst-office-payment">
			  @csrf
		  ...
		  <div class="row mt-3">
			<div class="col-xl-12 col-xxl-12 col-lg-12">
				...
				@if(!empty($data))
					...
					<tr><th class="text-center fs-14 mb-2">MATERIAL-GST OFFICE PAYMENT</th></tr>
					...
					<tr >
						...
						<th style="border-top:1px solid #727272;border-bottom:1px solid #727272;" align="left">&nbsp;&nbsp;Invoice_No</th>
						<th style="border-top:1px solid #727272;border-bottom:1px solid #727272;" align="left">&nbsp;&nbsp;Vendor</th>
						...
						<th style="border-top:1px solid #727272;border-bottom:1px solid #727272;" align="left">Unit</th>
						<th style="border-top:1px solid #727272;border-bottom:1px solid #727272;text-align:right">Rate</th>
						<th style="border-top:1px solid #727272;border-bottom:1px solid #727272; text-align:right;" >GST_Amt&nbsp;&nbsp;</th>
					...
					@php $gr_tot=0; @endphp
					 ...
					 @foreach($data as $dat)
						...
						<tr>
							...
							<td style="border-bottom:1px solid #e4e4e4;">{{$r['supp']??''}}</td>
							<td style="border-bottom:1px solid #e4e4e4;">{{$r['mat']??''}}</td>
							<td style="border-bottom:1px solid #e4e4e4;">{{$r['ptype']??''}}</td>
							<td style="border-bottom:1px solid #e4e4e4;" align="right" >{{$r['qty']??''}}</td>
							<td style="border-bottom:1px solid #e4e4e4;">{{$r['unit']??''}}</td>
							<td style="border-bottom:1px solid #e4e4e4;" align="right">{{number_format($r['rate'],'2','.',',')}}</td>
							<td style="border-bottom:1px solid #e4e4e4;width:120px;" align="right">{{number_format($r['gst_amt'],'2','.',',')}}</td>
							<td style="border-bottom:1px solid #e4e4e4;width:120px;" align="right">{{number_format($r['amt'],'2','.',',')}}</td>
						</tr>
						@endforeach
						
						<tr>
							<td colspan=10 style="border-bottom:1px solid #323030;width:120px;font-size:14px;font-weight:600;" align="right">Total</td>
							<td style="border-bottom:1px solid #323030;width:120px;font-size:14px;font-weight:600;" align="right">{{number_format($tot,'2','.',',')}}</td>
						</tr>
						
						<tr>
							<td colspan=11 style="border:none;" align="right">&nbsp;</td>
						</tr>
						@endforeach
					@endif
					</tbody>
					</table>
					<table class="tb-list" border=0 style="width:100%;font-weight:500;">
					
					<tr >
						<th colspan=6 style="text-align:right;border-bottom:1px solid #323030;">
						Total : &nbsp;
						</th>
						<th  style="width:120px;text-align:right;border-bottom:1px solid #323030;">
						<span style="width:200px;font-size:14px;text-align:right;">{{number_format($gr_tot,2,'.',',')}}</span>
						</th>
					</tr>
					</tfoot>
					</table>
