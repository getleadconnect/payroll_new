...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Other Sub-Category</h4>
					</div>
					</div>
				</div>
			...
			<div class="mt-3">
			<label class="mb-3" style="font-size:11px;"><b><u>Add Sub-Category</u></b> </label>
			
				<form method="POST" action="{{url('save-other-sub-category')}}" enctype="multipart/form-data">
				@csrf

					<div class="form-group">
					<label>Category Name</label>
					   <select class="form-control"  name="other_category_id" required>
					   <option value="">--select--</option>
					   @foreach($cats as $r)
					   <option value="{{$r->id}}">{{$r->other_category_name}}</option>
					   @endforeach
					   </select>
					</div>
					...
					<label>Sub-Category Name</label>
					   <input type="text" class="form-control input-default"  name="sub_category_name" required>
					</div>
 ...
 $('#datatable tbody').on( 'click', '.edit', function ()
  {
	...
	$("#ed_other_cat_id").val(id);
	$("#ed_other_category_name").val(cat);
	...
	var cid=$(this).attr('id');
		...
		var Result=$("#basicModal-1 .modal-body");
			...
			$(this).attr('data-target','#basicModal-1');
				...
				jQuery.ajax({
				type: "GET",
				url: "edit-other-sub-category"+"/"+cid,
				dataType: 'html',
				//data: {vid: vid},
...
$('#datatable tbody').on( 'click', '.btndel', function ()
  {
		if(confirm("Are you sure, delete this?"))
		{
			var cid=$(this).attr('id');
				jQuery.ajax({
				type: "GET",
				url: "delete-other-sub-category"+"/"+cid,
				dataType: 'html',
				//data: {vid: vid},
				success: function(res)
				{
