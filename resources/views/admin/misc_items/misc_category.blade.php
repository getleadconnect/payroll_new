...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Misc/Other Category</h4>
					</div>
					</div>
				</div>
			...
			<div class="mt-3">
			<label class="mb-3" style="font-size:11px;"><b><u>Add Category</u></b> </label>
				<form method="POST" action="{{url('save-misc-category')}}" enctype="multipart/form-data">
				@csrf

					<div class="form-group">
					<label>Category Name</label>
					   <input type="text" class="form-control input-default"  name="category_name" required>
					   @if($errors->has('category_name'))
						 <label class="lbl-error">{{$errors->first('category_name')}}</label>
					   @endif
					</div>
	...
	<div class="modal fade" id="basicModal-1" style="display: none;" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form method="POST" action="{{url('update-misc-category')}}" enctype="multipart/form-data">
				@csrf
				
				<input type="hidden" id="ed_misc_cat_id" name="ed_misc_cat_id">
				
				<div class="modal-body" style="padding-bottom:.5rem;">
					<div class="form-group">
					<label>Category Name</label>
					   <input type="text" class="form-control input-default"  id="ed_category_name" name="ed_category_name" required>
					</div>
 ...
 $('#datatable tbody').on( 'click', '.edit', function ()
  {
	...
	$("#ed_misc_cat_id").val(id);
	$("#ed_category_name").val(cat);
