...
<div class="row">
	...
	<div class="col-xl-12 col-xxl-12 col-lg-12">
		<div class="card">
		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Material Sub-Types</h4>
					</div>
					</div>
				</div>
			...
			<div class="mt-3">
			<label class="mb-3" style="font-size:11px;"><b><u>Add Material Sub-Type</u></b> </label>
				<form method="POST" action="{{url('save-material-sub-type')}}" enctype="multipart/form-data">
				@csrf
					...
					<label>Material Sub-Type Name</label>
					   <input type="text" class="form-control input-default"  name="sub_type_name" required>
					</div>
	...
	var cid=$(this).attr('id');
		...
		var Result=$("#basicModal-1 .modal-body");
			...
			$(this).attr('data-target','#basicModal-1');
				...
				jQuery.ajax({
				type: "GET",
				url: "edit-material-sub-type"+"/"+cid,
				dataType: 'html',
				//data: {vid: vid},
...
$('#datatable tbody').on( 'click', '.btndel', function ()
  {
		if(confirm("Are you sure, delete this?"))
		{
			var cid=$(this).attr('id');
				jQuery.ajax({
				type: "GET",
				url: "delete-material-sub-type"+"/"+cid,
				dataType: 'html',
				//data: {vid: vid},
				success: function(res)
				{
				   ...
				   {
					  table.draw();
					  alert("Material sub-type successfully removed.");
				   }
				}
			});
		}
