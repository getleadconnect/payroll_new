			...
			<div class="modal-content">
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-9 col-xl-9 col-xxl-9">
					      <input type="text" class="form-control input-default "  name="bank_name" value="NIL" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-6 col-xl-6 col-xxl-6">
					      <input type="text" class="form-control input-default "  name="bank_ifsc" value="NIL" required>
					  </div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
					  ...
					  <div class="col-lg-9 col-xl-9 col-xxl-9">
					      <input type="text" class="form-control input-default "  name="bank_account_no" value="NIL" required>
					  </div>
					</div>
				</div>
