		    ...
		    <div class="row card-title-align">
				<div class="col-lg-8 col-xl-8 col-xxl-8">
					...
					<div class="mr-auto pr-3">
						<h4 class="text-black fs-20">Misc-Vendors</h4>
					</div>
					</div>
				</div>
...
<div class="modal fade" id="basicModal-1" style="display: none;" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form method="POST" action="{{url('save-misc-vendor')}}" enctype="multi-part/form-data">
				@csrf
				...
				<div class="row">
				  ...
				  <div class="col-lg-6 col-xl-6 col-xxl-6">
				    <input type="text" class="form-control" name="pan_no" value="NIL">
				</div>
				</div>
				</div>
		...
		if(confirm("Are you sure, delete this?"))
		{
			var cid=$(this).attr('id');
				...
				success: function(res)
				{
				   ...
				   {
					  table.draw();
					  alert("Vendor details successfully removed.");
				   }
				}
			});
		}
